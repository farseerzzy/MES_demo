...
import { Button, Form, Row,Col,Input, Radio, InputNumber, Cascader, Select, AutoComplete } from 'antd';
...
class Customized extends Component{
    ...
    getData = () => {
        ...
        this.setState({
            //rowData: Server.globalData.userHealthInfo,
